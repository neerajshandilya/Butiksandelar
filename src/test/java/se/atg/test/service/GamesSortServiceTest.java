...
class GamesSortServiceTest {
    ...
    void testProcessGameListSampleSet1() {
        ...
        var output = gamesSortService.sortGamesList(getGameDataSampleSet1());
    ...
    void testProcessGameListDuringWinterBustPeriodGameSet1() {
        ...
        var output = gamesSortService.sortGamesList(getGameDataSampleSet2());
    ...
    @Test
    void testFindIndexToAddBigGameEvent() {
        when(clock.instant()).thenReturn(
                Instant.parse("2022-12-19T00:00:00.653Z"));
        var indexToAddBigGameEvent = gamesSortService.findIndexToAddBigGameEvent(createGameEvents("2022-12-19", "V64"));
        assertEquals(1, indexToAddBigGameEvent);
        indexToAddBigGameEvent = gamesSortService.findIndexToAddBigGameEvent(createGameEvents("2022-12-20", "V64"));
        assertEquals(0, indexToAddBigGameEvent);
    }


    @Test
    void testDiscardGameInPast() {
        when(clock.instant()).thenReturn(
                Instant.parse("2022-12-19T00:00:00.653Z"));
        assertFalse(gamesSortService.gameDateAreInFuture(createGameEvents("2022-12-18", "V64")));
        assertTrue(gamesSortService.gameDateAreInFuture(createGameEvents("2022-12-20", "V64")));
    }
    ...
    private List<GameEvent> getGameDataSampleSet1() {
        ...
        gameList.add(createGameEvents("2022-12-05", "V64"));
        gameList.add(createGameEvents("2022-12-06", "V64"));
        gameList.add(createGameEvents("2022-12-07", "V86"));
        gameList.add(createGameEvents("2022-12-08", "V64"));
        gameList.add(createGameEvents("2022-12-09", "V86"));
        gameList.add(createGameEvents("2022-12-10", "V75"));
        gameList.add(createGameEvents("2022-12-11", "GS75"));

        gameList.add(createGameEvents("2022-12-12", "V64"));
        gameList.add(createGameEvents("2022-12-13", "V64"));
        gameList.add(createGameEvents("2022-12-14", "V86"));
        gameList.add(createGameEvents("2022-12-15", "V64"));
        gameList.add(createGameEvents("2022-12-16", "GS75"));
        gameList.add(createGameEvents("2022-12-17", "V75"));
        gameList.add(createGameEvents("2022-12-18", "GS75"));
        return gameList;
    }
    ...
    private List<GameEvent> getGameDataSampleSet2() {
        ...
        gameList.add(createGameEvents("2022-12-19", "V64"));
        gameList.add(createGameEvents("2022-12-20", "V64"));
        gameList.add(createGameEvents("2022-12-21", "V86"));
        gameList.add(createGameEvents("2022-12-22", "V64"));
        gameList.add(createGameEvents("2022-12-23", "V75"));
        gameList.add(createGameEvents("2022-12-25", "V75"));

        gameList.add(createGameEvents("2022-12-26", "V75"));
        gameList.add(createGameEvents("2022-12-27", "V75"));
        gameList.add(createGameEvents("2022-12-28", "V75"));
        gameList.add(createGameEvents("2022-12-29", "V75"));
        gameList.add(createGameEvents("2022-12-30", "V75"));
        gameList.add(createGameEvents("2022-12-31", "V75"));
        return gameList;
    }
}